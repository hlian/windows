...
namespace MyPlugin
{
	...
	public class MyPluginInstaller : System.Configuration.Install.Installer
	{
		...
		public override void Install(System.Collections.IDictionary stateSaver)
		{
			...
			using (RegistryKey key = Registry.ClassesRoot.OpenSubKey(MyPlugin.ComPath, true))
			{
			...
			using (RegistryKey key = Registry.LocalMachine.CreateSubKey(MyPlugin.RegPath))
			{
				...
				key.SetValue(Registration.Capabilities,
					unchecked((int)PluginType.Background | (int)PluginFlags.HasPropertyPage),
					RegistryValueKind.DWord);

				key.SetValue(Registration.FriendlyName, "My Plugin Name");
		...
		public override void Uninstall(System.Collections.IDictionary savedState)
		{
			...
			// information.
			Registry.LocalMachine.DeleteSubKey(MyPlugin.RegPath, false);
		}
	}
}